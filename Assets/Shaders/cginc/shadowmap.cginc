...
#define _ShadowColor half4(0.3843,0.5451,0.6980,1)
//#define _ShadowColor _CustomShadowColor
...
/*#if defined(_RECEIVESHADOW)
		...
		#define MY_SHADOW_COORDS(idx1)
#if defined(_RECEIVESHADOW)
		#define MY_SHADOW_ATTENTION(a, normalWorld, posWorld) GetShadowAttenuation(posWorld, normalWorld);
		//#define MY_SHADOW_COORDS(idx1) //float4 _ShadowCoord : TEXCOORD##idx1;
#else
		#define MY_SHADOW_ATTENTION(a, normalWorld, posWorld) 1.0;
#endif