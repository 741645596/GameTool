#ifndef TERRAIN_CORE_ATLAS_INCLUDED
#define TERRAIN_CORE_ATLAS_INCLUDED
...
//
	...
	float3 ShadowColor = lerp(_ShadowColor, 1, ReceiveShadow);// + (1-ReceiveShadow)*_ShadowColor.rgb;
#endif
