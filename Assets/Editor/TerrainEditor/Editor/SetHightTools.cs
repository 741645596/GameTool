...
namespace UnityEditor.Experimental.TerrainAPI
{
    ...
    {
        const string toolName = "Smooth Height2";
        ...
        {
            //Material mat = new Material(Shader.Find("Hidden/TerrainEngine/PaintHeight")); ; TerrainPaintUtility.GetBuiltinPaintMaterial();
            if(mat == null) mat = new Material(Shader.Find("Hidden/TerrainEngine/PaintHeight2"));
