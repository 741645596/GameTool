...
Shader "Omega/Terrain/Standard_Overlay" 
{
    Properties 
    {
        ...
        _OverlayMap ("OverlayMap", 2D) = "black" {}
        _Overlay ("Overlay", Range(0, 1)) = 0.5
        _Rect ("LowerLeft(xy), Size(zw)", Vector) = (-2048, -2048, 4096, 4096)
    }
    ...
    SubShader {
        ...
        Pass
        {
            ...
            v2f vert(appdata_base v)
            {
                ...
                o.texcoord = (worldPos.xz - _Rect.xy) / _Rect.zw;
                return o;
		    }

            fixed4 frag(v2f i) : SV_Target
            {
                return fixed4(tex2D(_OverlayMap, i.texcoord).rgb, _Overlay);     
		    }
            ENDCG
	    }
	}
